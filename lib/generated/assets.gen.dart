...
class $AssetsIconsGen {
  ...
  /// File path: assets/icons/ic_cross_line.svg
  SvgGenImage get icCrossLine =>
      const SvgGenImage('assets/icons/ic_cross_line.svg');

  /// File path: assets/icons/ic_info.svg
  SvgGenImage get icInfo => const SvgGenImage('assets/icons/ic_info.svg');

  /// File path: assets/icons/ic_line_eye.svg
  SvgGenImage get icLineEye =>
      const SvgGenImage('assets/icons/ic_line_eye.svg');

  /// File path: assets/icons/ic_trash_line.svg
  SvgGenImage get icTrashLine =>
      const SvgGenImage('assets/icons/ic_trash_line.svg');
